...
"""
Remove the attribute from the system.

Throw an exception if the attribute is attached to a component.
If force is true, override that rule.
"""
remove_supplemental_attribute!(
    data::SystemData,
    attribute::SupplementalAttribute;
    force = false,
) = remove_supplemental_attribute!(data.supplemental_attribute_manager, attribute)
